...
axis_angle_msg origin     ( -2.90,   30.33,   100.44,   -0.50,   40.94,       0,   7);
axis_angle_msg wp_up_msg  ( 28.24,   65.55,   108.7,     0.49,   66.55,   -5.73,   7);
axis_angle_msg wp_down_msg( 28.24,   68.35,   110.39,       0,   67.24,   -5.74,   7);
axis_angle_msg detect_msg (-23.26,   67.59,   111.11,       0,   67.01,   -5.74,   7);
